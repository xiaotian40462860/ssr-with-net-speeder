...
appid   =   args[2] || 'all',
images  =   ["xiaotian40462860/ssr-with-net-speeder","lowid/ss-with-net-speeder","smounives/shadowsocksr-docker"];


app.get('/', function(req, res) {
    getit(appid,function(err,data){   
        if(err || !data)
            res.send('没有查询到数据。请检查node启动参数是否正确。更多内容请访问：https://github.com/xiaotian40462860/ssr-with-net-speeder/tree/arukas');
        else    
